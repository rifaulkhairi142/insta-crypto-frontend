...
import { Eye, EyeOff, Zap, Shield, ArrowLeft, Mail, Lock } from "lucide-react";
...
const LoginPage = () => {
  ...
  const showError = (msg) => {
    toast.error(msg, { autoClose: 2000, position: "top-right", theme:"dark" });
  };
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Masuk ke akunmu untuk melanjutkan </p>
          </div>
