...
const PaymentDetailPage = () => {
  ...
  useEffect(() => {
    if (!paymentDetail.qrisData.expiry) return;

    const expiryTime = new Date(paymentDetail.qrisData.expiry).getTime();
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="text-white font-semibold">
                      {paymentDetail.amount} {paymentDetail.coin}
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(paymentDetail.walletAddress)
                        }
            ...
            {paymentDetail.status === "pending" &&
              paymentDetail.paymentMethod === "QRIS" &&
              !isExpired && (
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
                  <h2 className="text-xl font-semibold text-white mb-6">
                    Pembayaran QRIS
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="text-center">
                      ...
                      <img src="https://api.sandbox.midtrans.com/v2/gopay/470c4211-e26f-45ef-bf4c-f022de1e992b/qr-code"/>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center p-3 bg-gray-700/30 rounded-lg">
                          ...
                          <span className="text-white font-medium">
                            {paymentDetail.qrisData.merchantName}
                          </span>
                        </div>
                        ...
                        <div className="flex justify-between items-center p-3 bg-gray-700/30 rounded-lg">
                          ...
                          <div className="flex items-center space-x-2">
                            <span className="text-white font-medium">
                              {paymentDetail.qrisData.merchantId}
                            </span>
                            <button
                              onClick={() =>
                                copyToClipboard(
