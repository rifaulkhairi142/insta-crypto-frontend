...
import ProfilePageSkeleton from '../../component/V 2/UI/ProfilePageSkeleton';
...
const ProfilePage = () => {
  ...
  const getMyProfile = async() => {
    try{
      ...
      const response = await axios.get(`${config.base_url}/customer/profile`);
      setProfileData(response?.data);


    }catch(error){
      setGetDataLoading(false);
      console.log("porfile error : ", error);
  ...
  if(getDataLoading) return <ProfilePageSkeleton/>;
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
              ...
              <div className="mt-6 pt-6 border-t border-gray-700">
                <div className="text-center">
                  ...
                  <p className="text-white font-semibold">{formatDateOp2(profileData.createdAt)}</p>
                </div>
              </div>
            </div>
          </div>
